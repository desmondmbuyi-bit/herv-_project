...
SUPABASE_URL = st.secrets.get("SUPABASE_URL", "https://ton-projet.supabase.co")
SUPABASE_KEY = st.secrets.get("SUPABASE_KEY", "ta-cle-api-supabase")
RESEND_API_KEY = st.secrets.get("RESEND_API_KEY", "re_ta_cle_api_resend")
